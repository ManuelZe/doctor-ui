...
import { SoldeActuel } from "@/components/solde_actuel"
import {
  SidebarInset,
  SidebarProvider,
  SidebarTrigger,
...
export default async function Page() {
  ...
  const doctorId = cookieStore.get("doctor_id")?.value || "Unknown"
  const federationId = cookieStore.get("federation_id")?.value || "Unknown"
  return (
    <SidebarProvider>
